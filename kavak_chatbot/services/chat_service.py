...
from kavak_chatbot.models.schemas.chat import InitializeChatResponse
...
class ChatService:
    ...
    def initialize_chat(self, phone_number: str = "1111", agent_id: Optional[UUID] = None) -> InitializeChatResponse:
        try:
