"""
Catalog Search Prompt Template

This file contains the prompt template for normalizing and correcting car search filters.
"""

CATALOG_SEARCH_NORMALIZATION_PROMPT_TEMPLATE = """
...
- Para el año (year), convierte a rango [min, max]:
  - Si dice "2020 o más nuevo": [2020, null]
  - Si dice "2018 o más viejo": [null, 2018]
  - Si dice "entre 2018 y 2022": [2018, 2022]
  - Si dice "2020": [2020, 2020] (año específico)
...
- El output debe ser un **JSON plano** con solo los campos válidos para la tabla "cars":
  - make, model, year (rango [min, max]), price (rango [min, max]), km (rango [min, max]), version, bluetooth, car_play
