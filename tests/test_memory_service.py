...
from kavak_chatbot.services import MemoryService, MemorySummaryConfig
...
class TestMemoryService:
    ...
    @patch('kavak_chatbot.services.memory_service.SessionLocal')
    def test_store_message_success(self, mock_session_local, memory_service, sample_chat_session_id, sample_message_data):
        ...
        with patch('kavak_chatbot.services.memory_service.ConversationMemoryDB') as mock_conversation_memory:
    ...
    @patch('kavak_chatbot.services.memory_service.SessionLocal')
    @patch('kavak_chatbot.services.memory_service.select')
    def test_get_or_create_summary_new_summary(self, mock_select, mock_session_local, memory_service, sample_chat_session_id):
        ...
        with patch('kavak_chatbot.services.memory_service.SummaryDB') as mock_summary_db:
    ...
    @patch('kavak_chatbot.services.memory_service.MemoryService._get_unsummarized_messages')
    ...
    @patch('kavak_chatbot.services.memory_service.MemoryService.should_summarize_conversation')
    @patch('kavak_chatbot.services.memory_service.MemoryService._get_unsummarized_messages')
    @patch('kavak_chatbot.services.memory_service.MemoryService._get_or_create_summary')
    @patch('kavak_chatbot.services.memory_service.MemoryService._generate_summary')
    @patch('kavak_chatbot.services.memory_service.MemoryService._mark_messages_as_summarized')
    @patch('kavak_chatbot.services.memory_service.MemoryService.get_conversation_summary')
    @patch('kavak_chatbot.services.memory_service.SessionLocal')
    ...
    @patch('kavak_chatbot.services.memory_service.MemoryService.get_conversation_summary')
    @patch('kavak_chatbot.services.memory_service.MemoryService.get_last_n_messages')
